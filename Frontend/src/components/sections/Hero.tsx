            ...
            >
              <div className="grid grid-cols-3 gap-8 lg:gap-12">
                <div className="text-center lg:text-left">
                  <div className="text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent mb-2">50M+</div>
                  <div className="text-sm lg:text-base text-gray-400 font-medium">Voices Generated</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent mb-2">99%</div>
                  <div className="text-sm lg:text-base text-gray-400 font-medium">Accuracy Rate</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent mb-2">150+</div>
                  <div className="text-sm lg:text-base text-gray-400 font-medium">Languages</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  <div className="text-sm lg:text-base font-bold text-white">Instant</div>
                  <div className="text-xs lg:text-sm text-gray-400">{'< 2 seconds'}</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  <div className="text-sm lg:text-base font-bold text-white">Premium</div>
                  <div className="text-xs lg:text-sm text-gray-400">Studio Grade</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
